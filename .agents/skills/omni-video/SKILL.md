...
# Omni Video Orchestrator Command (`/omni-video`)
...
**Fail-closed verification**: Confirm `./audio/${product-name}.mp3` exists and is > 0 bytes. If missing, STOP.

---

### Step 4: Video Generation (Phase 2 - SKIPPED AT THIS MOMENT)
